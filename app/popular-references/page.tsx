...
export default function PopularReferencesPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative py-32 overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 mt-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 text-balance">
              Popular{" "}
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">References</span>
            </h1>
            <p className="text-xl text-muted-foreground text-pretty">
              We have completed 900+ successful projects of multiple services across diverse industries. We have
              showcased few top projects here. Each project showcases our commitment to excellence and innovation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-4">
              Our <span className="text-primary">References</span>
            </h2>
          ...
          <Tabs defaultValue="All" className="w-full">
            ...
            <TabsContent value="All">
              <div className="grid lg:grid-cols-2 lg:grid-cols-3 gap-6">
                {portfolioData.slice(0, 12).map((item) => (
                  <Card
                    key={item.id}
            ...
            <TabsContent value="Education">
              <div className="grid lg:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="group relative overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-fit bg-white border-none rounded-xl">
                  <div className="block w-full h-full">
                    <div className="relative aspect-video overflow-hidden mx-0.5 mt-0.5">
                      <Link
                        href="https://skillforcareer.com"
                        target="_blank"
                        className="hidden lg:block absolute inset-0 z-10"
                      >
                        <span className="sr-only">Visit Skill For Career</span>
                      </Link>

                      <iframe
                        src="https://www.youtube.com/embed/m4jOJdmL3Rk?autoplay=1&mute=1&loop=1&playlist=m4jOJdmL3Rk&controls=0&showinfo=0&rel=0&iv_load_policy=3"
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4 text-center z-20">
                        <Badge className="mb-2 bg-primary text-white border-none">Education</Badge>
                        <h3 className="text-lg font-bold text-white mb-1">Skill For Career</h3>
                        <p className="text-white/90 text-xs mb-4 line-clamp-2">
                          Professional Training & Education platform providing industry-relevant skills.
                        </p>
                            ...
                            <DialogContent className="sm:max-w-[425px] bg-transparent border-none p-0 flex justify-center shadow-none">
                              <div className="relative w-[280px] h-[580px] bg-white rounded-[3rem] border-[12px] border-white shadow-[0_0_50px_rgba(0,0,0,0.3)] overflow-hidden outline outline-1 outline-slate-200">
                                ...
                                <div className="absolute inset-0 w-full h-full bg-black">
                                  <iframe
                                    src="https://www.youtube.com/embed/xLDLU5c-k7U?autoplay=1&mute=1&loop=1&playlist=xLDLU5c-k7U&controls=0&modestbranding=1&rel=0&showinfo=0"
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground text-sm">Skill Academy</p>
                  </CardContent>
                </Card>
