                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {/* ICON */}
                      <div
                        className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 transition-all duration-300 ${isOpen
                      ...
                      {/* TEXT */}
                      <h3
                        className={`text-base sm:text-lg lg:text-xl font-semibold transition-colors duration-300 ${isOpen
                          ? "text-primary"
                          : "text-foreground"
                          }`}
                      >
